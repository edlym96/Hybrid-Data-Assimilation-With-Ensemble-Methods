...
do
	...
	state_filepath=../data/matrix_prec_494/matrixVensembleSplit"$COUNTER"state.npz
	pressure_filepath=../data/matrix_prec_494/matrixVensembleSplit"$COUNTER"pressure.npz
	velocity_filepath=../data/matrix_prec_494/matrixVensembleSplit"$COUNTER"velocity.npz

	background_state_fp=../data/converted_data/background_state.npz
	...
	obs_state_fp=../data/converted_data/observations.npz
	...
	./VarDA_3Dtracers_Covariance.py -Vp $state_filepath -posp $pos_filepath -xBp $background_state_fp -yp $obs_state_fp
